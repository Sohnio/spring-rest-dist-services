package com.dhbw.distservice.spring.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SpringBootRestDistSystem101");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SpringBootRestDistSystem101");
        ...
        config.getMapConfigs().put("com.dhbw.distservice.spring.domain.*", initializeDomainMapConfig(jHipsterProperties));
